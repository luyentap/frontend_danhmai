...
export default class ListOrderByUserDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      details: [],
      ...
      <div>
        <div className="container">
          <div className="customer-admin admin">
            ...
            <button className="btn btn-primary  m-2"><Link to="/listorderbyuser" className="text-dark ">Trở lại</Link></button>
